...
namespace TestFramework
{
    ...
    public class AccountDetailsPOM : BasePageObject
    {
        ...
        IWebElement accountDetailsFirstName_InputField() { return driver.FindElement(By.Id("FirstName")); }
        IWebElement accountDetailsLastName_InputField() { return driver.FindElement(By.Id("LastName")); }
        IWebElement accountDetailsAddress1_InputField() { return driver.FindElement(By.Id("Address_StreetAddress1")); }
        IWebElement accountDetailsAddress2_InputField() { return driver.FindElement(By.Id("Address_StreetAddress2")); }
        IWebElement accountDetailsAddressCity_InputField() { return driver.FindElement(By.Id("Address_City")); }
        IWebElement accountDetailsAddressState_InputField() { return driver.FindElement(By.Id("Address_State")); }
        IWebElement accountDetailsAddressPostCode_InputField() { return driver.FindElement(By.Id("Address_PostCode")); }
        IWebElement accountDetailsSubmit_Button() { return driver.FindElement(By.XPath("//*[@id='form0']/div[2]/div/input")); }
        IWebElement accountDetailsSuccess_P() { return driver.FindElement(By.XPath("//*[@id='updateAccountDetails']/p")); }

        //Account links
        IWebElement accountDetails_Link() { return driver.FindElement(By.XPath("//a[contains(@href, '/Account/AccountDetails')]")); }

        //Update Password
        IWebElement updatePasswordCurrent_InputField() { return driver.FindElement(By.Id("CurrentPassword")); }
        IWebElement updatePasswordNew_InputField() { return driver.FindElement(By.Id("NewPassword")); }
        IWebElement updatePasswordConfirmNew_InputField() { return driver.FindElement(By.Id("NewPasswordConfirm")); }
        IWebElement updatePasswordSubmit_Button() { return driver.FindElement(By.XPath("//*[@id='form1']/div[2]/div/input")); }
        IWebElement updatePasswordSuccess_P() { return driver.FindElement(By.XPath("//*[@id='account-password-page']/div/div/p")); }
