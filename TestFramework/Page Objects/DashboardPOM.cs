...
namespace TestFramework
{
    ...
    public class DashboardPOM : BasePageObject
    {
        ...
        ///--Web Page Elements--///
        //Add Car Elements
        private IWebElement addCar_Link(){ return driver.FindElement(By.Id("add-vehicle-trigger")); }
        private IWebElement addCarVIN_Input() { return driver.FindElement(By.Id("inputVin")); }
        private IWebElement addCarSubmit_Button() { return driver.FindElement(By.XPath("//input[@value='Continue']")); }
        private IWebElement addCarPopUp_Yes_Button() { return driver.FindElement(By.XPath("//*[@id='form0']/div/div/ul/li[1]/input")); }
        private IWebElement addCarPopUp_No_Button() { return driver.FindElement(By.Id("wrongCar")); }
        private IWebElement addCarAlreadyRegisteredWarning_Container() { return driver.FindElement(By.XPath("//*[@id='myModal']/div[2]")); }
        private IWebElement addCarWarningPopUpClose_Link() { return driver.FindElement(By.XPath("//*[@id='myModal']/div[2]/a")); }
        private IWebElement addCarValidationError_Span() { return driver.FindElement(By.XPath("//*[@id='inputVin-error']")); }
        private IWebElement addCarErrorPopUp_Span() { return driver.FindElement(By.XPath("//*[@id='errors-summary']")); }
        private IWebElement addCarErrorPopUpClose_Button() { return driver.FindElement(By.Id("close-error-button")); }

        //Remove Car Elements
        private IWebElement removeAddedCar_Link() { return driver.FindElement(By.XPath("//*[@id='vehicle-dashboard-"+Settings.Default.AddedVIN+"']/div[2]/div/input")); }
        private IWebElement removeCarPopUp_Yes_Button() { return driver.FindElement(By.XPath("//*[@id='form6']/div/div/ul/li[1]/input")); }
        private IWebElement removeCarPopUp_No_Button() { return driver.FindElement(By.XPath("//*[@id='form6']/div/div/ul/li[2]/input")); }
        ...
        private IWebElement removeSIMOwnerPopUp_Yes_Button() { return driver.FindElement(By.XPath("//*[@id='form4']/div/div/ul/li[1]/input")); }
        private IWebElement removeSIMOwnerPopUp_Cancel_Button() { return driver.FindElement(By.XPath("//*[@id='form4']/div/div/ul/li[2]/input")); }
        private IWebElement removeSimOwner_Modal(string vin) { return driver.FindElement(By.XPath("//*[@id='modal-remove-user-liable-"+vin+"']")); }

        //General Elements
        private IWebElement reloadPlan_Icon() { return driver.FindElement(By.XPath("//div[2]/div/div/div/div/div[2]/div/div/img")); }
        private IWebElement carTab(string vin) { return driver.FindElement(By.XPath("//div[@data-id='" + vin + "']")); }
        private IWebElement back_Button() { return driver.FindElement(By.LinkText("Back")); }
        
        //Purchase Plan Elememts
        private IWebElement topUp_Button() { return driver.FindElement(By.LinkText("Top up")); }
        private IWebElement nationalPlan_Dropdown() { return driver.FindElement(By.Id("ui-id-1")); }
        private IWebElement nationalPlanFirst_Link() { return driver.FindElement(By.XPath("//form[@id='form0']/label/div/div[2]")); }
        private IWebElement europePlan_Dropdown() { return driver.FindElement(By.Id("ui-id-3")); }
        private IWebElement europePlanFirst_Link() { return driver.FindElement(By.XPath("//form[@id='form6']/label/div/div[2]")); }
        private IWebElement purchasePlanSubmit_Button() { return driver.FindElement(By.Id("completePurchase")); }

        //Credit Card Elements
        private IWebElement selectPaymentCard_Dropdown() { return driver.FindElement(By.Id("PaymentCardDetails_RegisteredPaymentCards_SelectedPaymentCardId")); }
        private IWebElement selectDifferentCard_Link() { return driver.FindElement(By.XPath("//*[@id='add-new-card-button_"+Settings.Default.CurrentVIN+"']")); }
        private IWebElement useSavedCard_Link() { return driver.FindElement(By.XPath("//*[@id='use-saved-card-button_" + Settings.Default.CurrentVIN + "']")); }

        private IWebElement cardHolderName_InputField() { return driver.FindElement(By.Id("PaymentCardDetails_AddPaymentCard_CardHolderName")); }
        private IWebElement cardType_Dropdown() { return driver.FindElement(By.Id("PaymentCardDetails_AddPaymentCard_CardType")); }
        private IWebElement cardNumber_InputField() { return driver.FindElement(By.Id("PaymentCardDetails_AddPaymentCard_CardNumber")); }
        private IWebElement cardVerificationCode_InputField() { return driver.FindElement(By.Id("PaymentCardDetails_AddPaymentCard_CardVerificationCode")); }
        private IWebElement cardExpireMonth_Dropdown() { return driver.FindElement(By.Id("PaymentCardDetails_AddPaymentCard_ExpireMonth")); }
        ...
        private IWebElement favouriteCar_Img() { return driver.FindElement(By.XPath("//img[@src='/Content/themes/audi/assets/icons/favourite-car-active.png']")); }
        private IWebElement favouriteCar_ToolTip() { return driver.FindElement(By.XPath("/html/body/descendant::span[text()='My Favorite Car']")); }

        //Pet Name Elements
        private IWebElement changePetName_Link() { return driver.FindElement(By.XPath("//*[@id='form2']/label/span")); }
        private IWebElement changePetName_InputField() { return driver.FindElement(By.XPath("//*[@id='PersonalizedCarName']")); }
        private IWebElement changePetNameSubmit_Button() { return driver.FindElement(By.Id("submit-form")); }
        private IWebElement currentPetName_Span() { return driver.FindElement(By.XPath("//*[@id='device-triggers-list']/div/div/div/div/div[1]/label")); }

        //Purchase History Elements
        private IWebElement purchaseHistory_Link() { return driver.FindElement(By.XPath("//*[@id='form1']/label/span")); }
        private IWebElement purchaseHistoryFromDate_InputField() { return driver.FindElement(By.Id("PurchaseHistoryFrom")); }
        private IWebElement purchaseHistoryToDate_InputField() { return driver.FindElement(By.Id("PurchaseHistoryTo")); }
        private IWebElement purchaseHistorySubmit_Button() { return driver.FindElement(By.XPath("//*[@id='form0']/div[2]/div/input")); }
        private IWebElement purchaseHistoryFromError_Span() { return driver.FindElement(By.XPath("//*[@id='form0']/div[2]/div/div[1]/div/span")); }
        private IWebElement purchaseHistoryToError_Span() { return driver.FindElement(By.XPath("//*[@id='form0']/div[2]/div/div[2]/div/span")); }
        private IWebElement purchaseHistoryFirstEntryInvoice_Link() { return driver.FindElement(By.XPath("//*[@id='p0']/div[1]/div/a")); }
        private IWebElement purchaseHistoryFirstEntryDate_Span() { return driver.FindElement(By.XPath("//*[@id='p0']/div[1]/div/span[1]")); }
        private IWebElement purchaseHistoryFirstEntryPlanName_Span() { return driver.FindElement(By.XPath("//*[@id='p0']/div[1]/div/span[2]")); }
        private IWebElement purchaseHistoryFirstEntryPurchaseBy_Span() { return driver.FindElement(By.XPath("//*[@id='p0']/div[1]/div/span[3]")); }
        private IWebElement purchaseHistoryFirstEntryPrice_Span() { return driver.FindElement(By.XPath("//*[@id='p0']/div[1]/div/span[4]")); }

        //Manage In Car Top Up Elements
        private IWebElement manageInCarTopUp_Link() { return driver.FindElement(By.XPath("//*[@id='form0']/label/span")); }
        private IWebElement manageInCarTopUpToggle_Input() { return driver.FindElement(By.XPath("//*[@id='toggle-top-up-"+Settings.Default.CurrentVIN+"']")); }
        private IWebElement manageInCarTopUpToggle_Label() { return driver.FindElement(By.XPath("//*[@id='form0']/div/div/div[1]/div[2]/div/label")); }
        private IWebElement manageInCarTopUpSelectCard_Dropdown() { return driver.FindElement(By.Id("RegisteredPaymentCards_SelectedPaymentCardId")); }
        private IWebElement manageInCarTopUpPhone_InputField() { return driver.FindElement(By.XPath("//*[@id='mobile-number-"+Settings.Default.CurrentVIN+"']")); }
        private IWebElement manageInCarTopUpLowBalance_Dropdown() { return driver.FindElement(By.Id("SponsorUserDetails_SendLowBalanceNotification")); }
        private IWebElement manageInCarTopUpLimit_Dropdown() { return driver.FindElement(By.Id("SponsorUserDetails_TopUpLimit_SelectedAmount")); }
        private IWebElement manageInCarTopUpEnable_Button() { return driver.FindElement(By.Id("submit-in-car-top-up-"+Settings.Default.CurrentVIN)); }
        private IWebElement manageInCarTopUpUpdate_Button() { return driver.FindElement(By.Id("update-in-car-top-up-" + Settings.Default.CurrentVIN)); }
        private IWebElement manageInCarTopUpDisable_Button() { return driver.FindElement(By.Id("disable-in-car-top-up-" + Settings.Default.CurrentVIN)); }
